...
typedef struct {
    ...
    int32_t max_route_value[MOTO_MAX_NUM];
} power_save_t;
...
void power_save_thread(void)
{
    ...
    power_save_1.moto_pos_info[MOTO_D] = get_encoder_currentCount(MOTO_D);
		power_save_1.max_route_value[MOTO_A] = max_route_value[MOTO_1];
		power_save_1.max_route_value[MOTO_B] = max_route_value[MOTO_2];
		power_save_1.max_route_value[MOTO_C] = max_route_value[MOTO_3];
		power_save_1.max_route_value[MOTO_D] = max_route_value[MOTO_4];
...
void power_load_thread(void)
{
    ...
    set_encoder_currentCount(MOTO_D, power_save.moto_pos_info[MOTO_D]);
		max_route_value[MOTO_1] = power_save.max_route_value[MOTO_A];
		max_route_value[MOTO_2] = power_save.max_route_value[MOTO_B];
		max_route_value[MOTO_3] = power_save.max_route_value[MOTO_C];
		max_route_value[MOTO_4] = power_save.max_route_value[MOTO_D];
