...
switch_moto_par_struct switch_moto_par[MOTO_MAX_NUM] = {0};
...
uint16_t moto1_switch = 0, moto2_switch = 0, moto3_switch = 0, moto4_switch = 0;
uint8_t moto1_cnt = 0, moto2_cnt = 0, moto3_cnt = 0, moto4_cnt = 0;
void switch_thread_run()
{
    ...
    adc_value[4] = get_switch_value(SWITCH_4);
		...
		moto1_switch = get_switch_value(SWITCH_2);
    if (moto1_switch > 2500)
    {
				switch_moto_par[MOTO_1].switch_down_flag = 0x01;
				switch_moto_par[MOTO_1].switch_target = -5000;
        
				
    }
    else if (moto1_switch > 1900)
    {		switch_moto_par[MOTO_1].switch_down_flag = 0x01;
				switch_moto_par[MOTO_1].switch_target = 5000;
		...
		{
			switch_moto_par[MOTO_1].switch_down_flag = 0;
    }
	
		moto2_switch = get_switch_value(SWITCH_3);
    if (moto2_switch > 2500)
    {
				switch_moto_par[MOTO_2].switch_down_flag = 0x01;
				switch_moto_par[MOTO_2].switch_target = 5000;
    ...
    else if (moto2_switch > 1900)
    {
		...
		{
				switch_moto_par[MOTO_2].switch_down_flag = 0;
    }
		moto3_switch = get_switch_value(SWITCH_1);
    if (moto3_switch > 2500)
    {
				switch_moto_par[MOTO_3].switch_down_flag = 0x01;
				switch_moto_par[MOTO_3].switch_target = -5000;
       
    }
    else if (moto3_switch > 1900)
    {
				switch_moto_par[MOTO_3].switch_down_flag = 0x01;
				switch_moto_par[MOTO_3].switch_target = 5000;
				...
				switch_moto_par[MOTO_3].switch_down_flag = 0;
    ...
    {
				switch_moto_par[MOTO_4].switch_down_flag = 0x01;
				switch_moto_par[MOTO_4].switch_target = 5000;
    ...
    else if (moto4_switch > 1900)
    {
				...
				switch_moto_par[MOTO_4].switch_down_flag = 0;
    }
#endif
