...
#define COM_USART0_RX_DMA_SUBPERI         DMA_SUBPERI4
...
#define COM_UART1_TX_GPIO_CLK             RCU_GPIOD
...
#define COM_USART1_DMA_RCU                RCU_DMA0
#define COM_USART1_DMA                    DMA0
#define COM_USART1_TX_DMA_SUBPERI         DMA_SUBPERI4
#define COM_USART1_RX_DMA_SUBPERI         DMA_SUBPERI4
...
#define COM_USART2_TX_GPIO_CLK             RCU_GPIOD
#define COM_USART2_TX_GPIO_AF              GPIO_AF_7
#define COM_USART2_TX_PORT                 GPIOD
#define COM_USART2_TX_PIN                  GPIO_PIN_8
#define COM_USART2_RX_GPIO_CLK             RCU_GPIOD
#define COM_USART2_RX_GPIO_AF              GPIO_AF_7
#define COM_USART2_RX_PORT                 GPIOD
#define COM_USART2_RX_PIN                  GPIO_PIN_9
